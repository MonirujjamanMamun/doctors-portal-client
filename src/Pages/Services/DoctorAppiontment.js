...
const DoctorAppiontment = () => {
    return (
        <div className="px-12 my-20">
            <div style={{ backgroundImage: `url(${bgDoctorAppiontment})` }} className="flex items-center justify-center bg-auto bg-no-repeat grid gird-cols-1 md:grid-cols-2 lg:grid-cols-2">
